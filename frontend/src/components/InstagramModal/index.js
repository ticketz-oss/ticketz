...
const Schema = Yup.object().shape({
    ...
    facebookPageUserId: Yup.string().required("Page ID obrigatório"),
    facebookUserToken: Yup.string().required("Token obrigatório"),
});
...
const InstagramModal = ({ open, onClose, whatsAppId }) => {
    ...
    return (
        <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth scroll="paper">
            <DialogTitle>
                {whatsAppId ? "Editar conexão Instagram" : "Nova conexão Instagram"}
            </DialogTitle>
            <Formik
                    ...
                    <Form>
                        <DialogContent dividers>
                            <Typography className={classes.hint}>
                                Configure sua conta Instagram Business via Meta Graph API.
                                URL Webhook: <strong>https://note.lpvoicetecnologia.com.br/backend/webhook/meta</strong>
                            </Typography>
                            <Field
                                as={TextField}
                            ...
                            <Field
                                as={TextField}
                                label="Page ID (Facebook Page vinculada ao Instagram)"
                            ...
                            <Field
                                as={TextField}
                                label="Instagram Business Account ID (opcional)"
