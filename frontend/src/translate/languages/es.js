    ...
    translations: {
      ...
      queueModal: {
        ...
        form: {
          ...
          whatsapp: {
            selectTitle: "Conexión de WhatsApp",
          },
          name: "Nombre",
          description: "Descripción",
          visibleToIntegrations: "Visible para integraciones",
          color: "Color",
      ...
      userModal: {
        ...
        form: {
          ...
          password: "Contraseña",
          profile: "Perfil",
          hideAdminUI: "Ocultar interfaz de administrador",
        },
        buttons: {
          okAdd: "Agregar",
          okEdit: "Guardar",
      ...
      aboutpro: {
        aboutdetail: "Sistema de Multiatención Whitelabel para provisión como servicio (SaaS)",
        licenseheading: "Licencia para uso exclusivo",
        licensedetail: "Ticketz PRO está licenciado para uso exclusivo en sistemas autorizados. Para más información, consulte el sitio web del producto."
      },
      schedules: {
        title: "Agendamentos",
        confirmationModal: {
      ...
      settings: {
        ...
        "storageOptions": {
          "title": "Configuración de almacenamiento de objetos",
        },
        WelcomeGreeting: {
          greetings: "hola",
      ...
      backendErrors: {
        ...
        ERR_SUBSCRIPTION_EXPIRED: "La suscripción ha expirado",
      ...
      wavoipModal: {
        ...
        coupon: "¡Al contratar el servicio use el cupón CHATVOIP para ganar un descuento!",
      },
      ticketz: {
        pro: {
          ...
          subscriptionTitle: "Suscripción Ticketz PRO",
          callToSubscribe: "Haz clic aquí para suscribirte a Ticketz PRO",
          stepperStart: "Comenzar",
          stepperCustomer: "Datos del Cliente",
          stepperPayment: "Método de Pago",
          stepperProcessing: "Procesando Pago",
          stepperDone: "¡Listo!",
          subscribeInstructions: "* Si tienes un código de activación, haz clic en el botón `<Ingresar Código>`\n* Para suscribirte con Tarjeta de Crédito, haz clic en el botón `<Suscribirse>`",
          ...
          boletoInstructions: "Para pagar por PIX/Boleto, primero debes hacer el pago del boleto. Una vez que se realice el pago, el sistema se activará automáticamente.\n\nPara continuar con esta modalidad, haz clic en el botón `Pagar`.",
          pixFinishInstructions: "Utiliza el código QR para realizar el pago.\n\nSi lo prefieres, puedes hacer clic en el botón `Copiar` y usar el modo \"Copiar y Pegar\" de tu aplicación de pagos.\n\nDespués de realizar el pago, espera unos segundos y haz clic en el botón `Proceder`.",
          processing: "Procesando...",
          paymentRefused: "Pago rechazado",
          renewAt: "Se renovará el",
          cancelSubscription: "Cancelar Suscripción",
          cancelSubscriptionQuestion: "¿Cancelar Suscripción?",
          cancelSubscriptionDetails: "La suscripción será cancelada al final del período contratado. Esta acción no puede revertirse, y para volver a utilizar el sistema será necesario hacer una nueva suscripción.",
          willCancelAt: "Se cancelará el",
          resetLicense: "Restablecer Licencia",
          resetLicenseQuestion: "¿Restablecer Licencia?",
          resetLicenseDetails: "Esto eliminará la licencia que aún está activa.\n\nPodrás agregarla nuevamente usando la clave de activación o adquirir una nueva licencia.\n\n**¡ADVERTENCIA: El sistema dejará de operar inmediatamente!**",
          back: "Anterior",
          close: "Cerrar",
          cancel: "Cancelar",
          activate: "Activar",
