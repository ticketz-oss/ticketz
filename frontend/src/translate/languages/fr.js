    ...
    translations: {
      ...
      contacts: {
        ...
        details: {
          ...
          tags: "Étiquettes",
          chatbot: "Chatbot",
          unavailable: "Impossible de charger les données de ce contact.",
          emptyEmail: "Aucun email renseigné",
          emptyTags: "Aucune étiquette liée",
          emptyExtraInfo: "Aucune information supplémentaire disponible.",
          close: "Fermer",
          edit: "Modifier le contact"
        }
      },
      ...
      mainDrawer: {
        ...
        appBar: {
          ...
          user: {
            profile: "Profil",
            subscriptionValidUntilLabel: "Abonnement valide jusqu'au",
      ...
      whitelabel: {
        ...
        primaryColorDark: "Couleur primaire foncée",
        lightLogo: "Logo clair de l'application",
        darkLogo: "Logo sombre de l'application",
