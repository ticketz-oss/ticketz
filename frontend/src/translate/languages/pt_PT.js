  ...
  pt_PT: {
    translations: {
      ...
      about: {
        ...
        licensedetail: "O erpcon está licenciado sob a GNU Affero General Public License versão 3, isso significa que qualquer utilizador que tiver acesso a esta aplicação tem o direito de obter acesso ao código fonte. Mais informações nos links abaixo:",
      ...
      erpcon: {
        registration: {
          header: "Registe-se na base de utilizadores do ERPCon",
          description: "Preencha os campos abaixo para se registar na base de utilizadores do ERPCon e receber novidades sobre o projeto.",
          name: "Nome",
          country: "País",
