    ...
    translations: {
      ...
      queueModal: {
        ...
        form: {
          ...
          visibleToIntegrations: "Visible to Integrations",
          color: "Color",
      ...
      settings: {
        ...
        enforceNumberCheck: "Enforce number check",
        settings: {
          userCreation: {
            name: "User creation",
            options: {
      ...
      ticketz: {
        pro: {
          ...
          stepperProcessing: "Processing Payment",
          stepperDone: "Done!",
          subscribeInstructions: "* If you have an activation code click on `<Enter Code>` button\n* To subscribe using Credit Card click on `<Subscribe>` button",
          ...
          perMonth: "/month",
          invalidKey: "Invalid Activation Code",
          boleto: "PIX/Bank Slip",
          creditCard: "Credit Card",
          boletoInstructions: "First payment is made via PIX and must be paid for the system to be activated. Subsequent payments will be made via bank slip, but it will always be possible to pay via PIX within the system.\n\nTo proceed with this option, simply click on the `Pay` button.",
          pixFinishInstructions: "Use the QR Code to make the payment.\n\nAlternatively, you can click on the `Copy` button and use the \"Copy and Paste\" mode in your payment app.\n\nAfter making the payment, wait a few seconds and click on the `Proceed` button.",
          processing: "Processing...",
          paymentRefused: "Payment refused",
          renewAt: "Will renew at",
          cancelSubscription: "Cancel Subscription",
          cancelSubscriptionQuestion: "Cancel Subscription?",
          cancelSubscriptionDetails: "The subscription will be canceled at the end of the current contracted period. This action cannot be reversed, and to use the system again, a new subscription will be required.",
          willCancelAt: "Will cancel at",
          resetLicense: "Reset License",
          resetLicenseQuestion: "Reset License?",
          resetLicenseDetails: "This will remove the license that is still active.\n\nYou can add it again using the activation key or purchase a new license.\n\n**WARNING: The system will stop operating immediately!**",
          back: "Back",
          close: "Close",
          cancel: "Cancel",
          activate: "Activate",
