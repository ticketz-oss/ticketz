const messages = {
  id: {
    translations: {
      ...
      ticketz: {
        pro: {
          markProStart: "digunakan hanya untuk menandai posisi awal string eksklusif PRO",
          markProEnd: "digunakan hanya untuk menandai posisi akhir string eksklusif PRO",
          markSubscriptionStart: "digunakan untuk menandai posisi awal string eksklusif langganan",
          subscriptionTitle: "Langganan Ticketz PRO",
          stepperStart: "Mulai",
          stepperAddress: "Isi Email dan Alamat",
          stepperPayment: "Selesaikan Pembayaran",
          stepperDone: "Selesai!",
          subscribeInstructions: "* Jika Anda memiliki kode aktivasi, klik tombol `<Masukkan Kode>`\n* Untuk berlangganan menggunakan Kartu Kredit, klik tombol `<Berlangganan>`",
          ...
          cancelSubscriptionDetails: "Langganan akan dibatalkan pada akhir periode yang telah dikontrak. Tindakan ini tidak dapat dibatalkan, dan untuk menggunakan sistem lagi, diperlukan langganan baru.",
          willCancelAt: "Akan dibatalkan pada",
          resetLicense: "Atur Ulang Lisensi",
          resetLicenseQuestion: "Atur Ulang Lisensi?",
          resetLicenseDetails: "Ini akan menghapus lisensi yang masih aktif.\n\nAnda dapat menambahkannya lagi menggunakan kunci aktivasi atau membeli lisensi baru.\n\n**PERINGATAN: Sistem akan berhenti beroperasi segera!**",
          back: "Kembali",
          close: "Tutup",
          cancel: "Batalkan",
          activate: "Aktifkan",
