    ...
    translations: {
      ...
      whatsappModal: {
        ...
        form: {
          name: "Nome",
          default: "Padrão",
          restrictToQueues: "Restringir às filas associadas ou sem associação",
          transferToNewTicket: "Força transferência para novo ticket"
        },
        tab: {
          general: "Geral",
          messages: "Mensagens",
      ...
      settings: {
        ...
        "AllowSilentlyClose": {
          "title": "Permitir fechar ticket silenciosamente",
        },
        "DesktopActionIconZoom": {
          "title": "Tamanho do ícone de ação do ticket",
        },
        ...
        "storageOptions": {
          "title": "Configuração de Armazenamento de Objetos",
        },
        WelcomeGreeting: {
          greetings: "Olá",
      ...
      wavoipModal: {
        ...
        coupon: "Ao contratar o serviço use o cupom CHATVOIP para ganhar um desconto!",
      },
      ticketz: {
        pro: {
          ...
          stepperProcessing: "Processando Pagamento",
          stepperDone: "Concluído!",
          subscribeInstructions: "* Se você tem um código de ativação, clique no botão `Inserir Código`\n* Para assinar clique no botão `Assinar`",
          ...
          perMonth: "/mês",
          invalidKey: "Código de Ativação Inválido",
          boleto: "PIX/Boleto",
          creditCard: "Cartão de Crédito",
          boletoInstructions: "A primeira cobrança é feita por PIX e precisa ser paga para que o sistema seja ativado. As próximas cobranças serão feitas por boleto bancário, mas sempre será possível pagar por PIX dentro do próprio sistema.\n\nPara prosseguir com essa modalidade basta clicar no botão `Pagar`",
          pixFinishInstructions: "Utilize o QR Code para fazer o pagamento.\n\nSe preferir você pode clicar no botão `Copiar` e usar o modo \"Copia e Cola\" do seu aplicativo de pagamentos.\n\nApós fazer o pagamento aguarde alguns segundos e clique no botão `Prosseguir`.",
          processing: "Processando...",
          paymentRefused: "Pagamento recusado",
          renewAt: "Será renovado em",
          cancelSubscription: "Cancelar Assinatura",
          cancelSubscriptionQuestion: "Cancelar Assinatura?",
          cancelSubscriptionDetails: "A assinatura será cancelada ao final do período já contratado. Essa ação não pode ser revertida e para voltar a utilizar o sistema será necessário fazer uma nova assinatura.",
          willCancelAt: "Será cancelado em",
          resetLicense: "Redefinir Licença",
          resetLicenseQuestion: "Redefinir Licença?",
          resetLicenseDetails: "Isso irá remover a licença que ainda está ativa.\n\nVocê poderá adicioná-la novamente através da chave de ativação ou adquirir uma nova licença.\n\n**ATENÇÃO: O sistema vai parar de operar imediatamente!**",
          back: "Voltar",
          close: "Fechar",
          cancel: "Cancelar",
          activate: "Ativar",
