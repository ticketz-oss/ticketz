...
import ERPConRegistry from "../../components/ERPConRegistry";
...
const useStyles = makeStyles((theme) => ({
  ...
  erpconProPaper: {
    ...
    overflowY: "auto",
    minHeight: 300,
    backgroundColor: theme.palette.erpconproad.main,
    color: theme.palette.erpconproad.contrastText,
    ...theme.scrollbarStyles,
  },
  erpconRegistryPaper: {
    padding: theme.spacing(2),
...
const Dashboard = () => {
  ...
  useEffect(async () => {
    const registry = await api.get("/erpcon/registry");
        ...
        <Grid container spacing={3} justifyContent="flex-start">
          ...
          { !localStorage.getItem("hideAds") && <OnlyForSuperUser
            ...
            yes={() => (
              ...
              <Grid item xs={12}>
                {!registered &&
                  <Paper className={classes.erpconRegistryPaper}>
                    <ERPConRegistry onRegister={setRegistered} />
                  </Paper>
                }
              </Grid>
              <Grid item xs={12} md={8}>
                <Paper className={clsx(classes.erpconProPaper, {
                  [classes.clickpointer]: !proInstructionsOpen,
                })} onClick={() => showProInstructions()}>
                  <Grid container justifyContent="flex-end">
                    <Grid className={classes.erpconProBox} item xs={12} sm={4}>
                      <div>
                        <img className={classes.erpconProScreen} src="https://pro.ticke.tz/images/0/7/3/0/b/0730b234af7b4b0dac72d09828863bb7cb9193ea-erpcon-computador.png" />
                      </div>
                    </Grid>
                    { !proInstructionsOpen &&
                    <Grid className={classes.erpconProBox} item xs={12} sm={8}>
                      <Typography className={classes.erpconProTitle} component="h3" variant="h5" gutterBottom>
                        ERPCon PRO
                      </Typography>
                      <Typography component="h4" variant="h7" gutterBottom>
                      <ul className={classes.erpconProFeatures}>
                    ...
                    <Grid className={classes.erpconProBox} item xs={12} sm={8}>
                      ...
                      <Typography className={classes.erpconProCommand} paragraph>
                        curl -sSL update.ticke.tz | sudo bash -s pro
                      </Typography>
                      <Typography paragraph>
                        Em instantes o ERPCon PRO estará instalado com todos os teus dados,
                        agora só precisa ir até o menu de usuário, clicar em "Assinatura do
                        ERPCon PRO" e fazer a sua assinatura.
                      </Typography>
                      <Typography paragraph>
                        Se a tua instalação for diferente ou acredita que precisa
                        de auxílio para instalar o ERPCon
                    ...
                    <Grid container justifyContent="flex-end">
                      <Grid className={classes.supportBox} style={{maxHeight: supportPix ? 300 : 35} } item xs={12}>
                        ...
                        <div
                          ...
                          <div>
                            <img className={classes.paymentpix} src="/erpconpix.png" />
                          </div>
                      ...
                      <Grid className={classes.supportBox}  style={{maxHeight: supportPix ? 35 : 300 }} item xs={12} onClick={() => setSupportPix(false)}>
                        <Typography
                          ...
                          component="h3" variant="h6"
                          gutterBottom onClick={() => setSupportPix(true)}>
                          {i18n.t("erpcon.support.mercadopagotitle")}
                        </Typography>
                        { supportPix || <> 
                        {supportIsBr && <>
                          <Typography component="body2" paragraph>
                            {i18n.t("erpcon.support.recurringbrl")}
                          </Typography>
                        ...
                        {!supportIsBr && <>
                          <Typography component="body2" paragraph>
                            {i18n.t("erpcon.support.international")}
                          </Typography>
